...
execute if score $get_coordinates.within_524288 iris matches 0 positioned ~ ~ ~0.524288 run function pk_wast:iris/get_coordinates/z/1
execute if score $get_coordinates.within_524288 iris matches 1 run function pk_wast:iris/get_coordinates/z/1

#> pk_wast:iris/find_closest_surface/ray_intersects_with_surface
#
...
#
# @within pk_wast:iris/find_closest_surface/bottom/find_intersection
# @within pk_wast:iris/find_closest_surface/east/find_intersection
# @within pk_wast:iris/find_closest_surface/north/find_intersection
# @within pk_wast:iris/find_closest_surface/south/find_intersection
# @within pk_wast:iris/find_closest_surface/top/find_intersection
# @within pk_wast:iris/find_closest_surface/west/find_intersection
...
data modify storage pk_wast:iris.data ContactSurface set from storage pk_wast:iris.data List[-1]
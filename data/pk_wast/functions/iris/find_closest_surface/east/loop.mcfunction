#> pk_wast:iris/find_closest_surface/east/loop
#
# Determines if the ray hits the current surface
#
# @within pk_wast:iris/find_closest_surface/east/main
# @within pk_wast:iris/find_closest_surface/east/loop
...
execute if score ${x} iris > $x0 iris run function pk_wast:iris/find_closest_surface/east/get_distance

#> pk_wast:iris/find_closest_surface/south/loop
#
# Determines if the ray hits the current surface
#
# @within pk_wast:iris/find_closest_surface/south/main
# @within pk_wast:iris/find_closest_surface/south/loop
...
execute if score ${z} iris > $z0 iris run function pk_wast:iris/find_closest_surface/south/get_distance

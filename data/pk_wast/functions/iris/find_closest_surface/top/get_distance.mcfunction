#> pk_wast:iris/find_closest_surface/top/get_distance
#
...
execute if score $distance iris < $min_distance_to_surface iris run function pk_wast:iris/find_closest_surface/top/find_intersection
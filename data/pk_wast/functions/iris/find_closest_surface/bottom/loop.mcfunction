#> pk_wast:iris/find_closest_surface/bottom/loop
#
# Determines if the ray hits the current surface
#
# @within pk_wast:iris/find_closest_surface/bottom/main
...
execute if score ${y} iris < $y0 iris run function pk_wast:iris/find_closest_surface/bottom/get_distance

...
execute if score $distance_to_next_block_on_x_axis iris <= $distance_to_next_block_on_y_axis iris if score $distance_to_next_block_on_x_axis iris <= $distance_to_next_block_on_z_axis iris run data merge storage pk_wast:iris.data {ShortestDistanceAxis: "x"}
execute if score $distance_to_next_block_on_y_axis iris <= $distance_to_next_block_on_x_axis iris if score $distance_to_next_block_on_y_axis iris <= $distance_to_next_block_on_z_axis iris run data merge storage pk_wast:iris.data {ShortestDistanceAxis: "y"}
execute if score $distance_to_next_block_on_z_axis iris <= $distance_to_next_block_on_x_axis iris if score $distance_to_next_block_on_z_axis iris <= $distance_to_next_block_on_y_axis iris run data merge storage pk_wast:iris.data {ShortestDistanceAxis: "z"}
...
execute if data storage pk_wast:iris.data {ShortestDistanceAxis: "x"} run function pk_wast:iris/find_next_block/x
execute if data storage pk_wast:iris.data {ShortestDistanceAxis: "y"} run function pk_wast:iris/find_next_block/y
execute if data storage pk_wast:iris.data {ShortestDistanceAxis: "z"} run function pk_wast:iris/find_next_block/z
